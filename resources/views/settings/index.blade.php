                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('settings') }}" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" aria-label="Sizing example input" name="email"  value="{{ $settings->email }}"  aria-describedby="inputGroup-sizing-sm">
                                        @error('email')
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror" aria-label="Sizing example input" name="phone"  value="{{ $settings->phone }}"  aria-describedby="inputGroup-sizing-sm">
                                        @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('terms_and_conditions_en') }}</span>
                                        <textarea name="terms_and_conditions_en" class="form-control  @error('terms_and_conditions_en') is-invalid @enderror"  rows="4" cols="50">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('terms_and_conditions_ar') }}</span>
                            ...
                            <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('privacy_policy_en') }}</span>
                                        <textarea name="privacy_policy_en" class="form-control  @error('privacy_policy_en') is-invalid @enderror"  rows="4" cols="50">
                            ...
                            <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('privacy_policy_ar') }}</span>
                            ...
                            <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('privacy_policy_he') }}</span>
                            ...
                            <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('about_en') }}</span>
                            ...
                            <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('about_ar') }}</span>
                            ...
                            <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        <span class="input-group-text" id="inputGroup-sizing-sm">{{ __('about_he') }}</span>

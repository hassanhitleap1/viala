                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" aria-label="Sizing example input" name="name"  value="{{ $customer->name }}"  aria-describedby="inputGroup-sizing-sm">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="email" class="form-control" aria-label="Sizing example input" name="email"  value="{{ $customer->email }}"  aria-describedby="inputGroup-sizing-sm">
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
